...
print('Tekst, ktory podales:         {}'.format(sygnal))
print('Zakodowany tekst: {}'.format(''.join([str(s) for s in zakodowany_sygnal])))
print('Odkodowany tekst: {}'.format(odkodowany_sygnal))
print("Liczba danych znakow w podanym przez Nas tekscie liczy sobie :\n "+ str(all_freq))